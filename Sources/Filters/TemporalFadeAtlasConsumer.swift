...
/// Metal atlas consumer that averages multiple temporal samples from the atlas
/// using a fixed spacing between each sampled frame.
public final class TemporalFadeAtlasConsumer {
    public var frameCount: Int
    public var frameSpacing: Int

    private struct TemporalFadeAtlasUniforms {
    ...
    public func render(
        ...
        var uniforms = TemporalFadeAtlasUniforms(
        ...
        encoder.setBytes(&uniforms, length: MemoryLayout<TemporalFadeAtlasUniforms>.stride, index: 0)
    ...
    private static func makePipeline(device: MTLDevice) -> MTLComputePipelineState? {
        ...
        if
            ...
            let function = library.makeFunction(name: "temporalFadeAtlasKernel"),
